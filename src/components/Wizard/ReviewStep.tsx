      ...
      <div className="bg-white">
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            {(!frequencies || (frequencies.schedules.length === 0 && frequencies.datasetTriggers.length === 0)) ? (
              ...
              <div className="space-y-4">
                {/* Calendar Schedules */}
                {frequencies?.schedules?.map((schedule: any, index: number) => (
                ...
                {/* Dataset Triggers */}
                {frequencies?.datasetTriggers?.map((trigger: any, index: number) => (
