...
// Import components
import StepIndicator from "./StepIndicator"; // Restored original component
...
const JobSchedulingWizard = () => {
  ...
  const handleFrequencyContinue = (frequencies: any) => {
    updateWizardData({ frequencies, showSecondaryFields: true });
    updateStepCompletion(3, true);
    goToNextStep();
  };

  const handleBackFromFrequency = () => {
      setCurrentStep(1);
      updateWizardData({ showSecondaryFields: true });
    };

    const handleBackFromSecondaryField = () => {
      console.log('handleBackFromSecondaryField')
      setCurrentStep(1);
      updateWizardData({ showSecondaryFields: false });
    };
      ...
      <div className="px-8 pb-8">
        ...
        {currentStep === 1 && (
          <JobDefinitionFormWizard
            ...
            onBack={handleBackFromSecondaryField}
          />
        )}
        ...
        {currentStep === 2 && (
          <FrequencyInformation
            ...
            onBack={handleBackFromFrequency}
          />
        )}
