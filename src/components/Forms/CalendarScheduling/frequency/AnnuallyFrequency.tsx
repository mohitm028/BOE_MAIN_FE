...
import { annualDayOptions } from "../calendar.types";
import HelpOutlineIcon from '@mui/icons-material/HelpOutline';
export const AnnuallyFrequency = ({control }: any) => (
    <div className="mb-6">
        ...
        <div className="flex items-center gap-2 mb-2">
            ...
            <HelpOutlineIcon
                ...
                titleAccess="Expected run days of the year"
            />
        </div>
        <Controller
            name="runDays"
            ...
            render={({ field }) => (
                <div>
                    ...
                    >
                        ...
                        {annualDayOptions.slice(1, 365).map(option => (
